...
//                }
    ...
    public ArrayList<Long> markMessagesAsDeleted(long dialogId, ArrayList<Integer> messages, boolean useQueue, boolean deleteFiles, int mode, int topicId) {
        ...
        // Nekogram: Show Deleted Messages — skip removing from storage
                        ...
                        if (load_type == -2) {
                            ...
                            if (exist = cursor.next()) {
                                ...
                                if (data != null) {
                                    ...
                                    data.reuse();
                                    // Nekogram: Save edit history before overwrite
                                    if (tw.nekomimi.nekogram.NekoConfig.saveEditsHistory &&
                                            oldMessage.message != null && message.message != null &&
                                            !oldMessage.message.equals(message.message)) {
                                        tw.nekomimi.nekogram.helpers.MessageEditsDatabase.getInstance(ApplicationLoader.applicationContext)
